...
public class TourServiceImpl implements TourService {
    ...
    public Long saveNewTour(TourDto tourDto) {
        TourEntity te = new TourEntity(Long.MIN_VALUE, tourDto.getName(), tourDto.getDescription(), tourDto.getFrom_location(), tourDto.getTo_location(), tourDto.getTransportType(), "", "", "");
    ...
    public List<TourDto> getAllTours() {
        ...
        for (TourEntity te : list_tourstour) {
            list_tours.add(new TourDto(te.getId(), te.getName(), te.getDescription(), te.getFrom_location(), te.getTo_location(), te.getTransportType()));
        }
        return list_tours;
    }
    ...
    public List<TourDto> getTourById(Long id) {
        ...
        list_tours.add(new TourDto(tour_entity.getId(), tour_entity.getName(), tour_entity.getDescription(), tour_entity.getFrom_location(), tour_entity.getTo_location(), tour_entity.getTransportType()));
        return list_tours;
    ...
    public TourDto updateTour(TourDto tourDto) {
        ...
        if (foundedTour != null) {
            ...
            return new TourDto(updatedTourEntity.getId(), updatedTourEntity.getName(), updatedTourEntity.getDescription(), updatedTourEntity.getFrom_location(), updatedTourEntity.getTo_location(), updatedTourEntity.getTransportType());
